...
class ShapeModelTransformationsNode(override val parent: GroupNode)
  ...
  private def isPoseDefined: Boolean = {
    children.exists(tr => tr.transformation.isInstanceOf[RotationThenTranslation[_3D]])
  }
  ...
  def addPoseTransformation(
    transformation: RotationThenTranslation[_3D],
    name: String = "pose"
  ): Try[ShapeModelTransformationComponentNode[RotationThenTranslation[_3D]]] = {
  ...
  def poseTransformation: Option[ShapeModelTransformationComponentNode[RotationThenTranslation[_3D]]] =
    children
      .find(_.transformation.isInstanceOf[RigidTransformation[_3D]])
      .map(_.asInstanceOf[ShapeModelTransformationComponentNode[RotationThenTranslation[_3D]]])
...
object ShapeModelTransformationComponentNode {
  def apply(parent: ShapeModelTransformationsNode, initialTransformation: RotationThenTranslation[_3D], name: String) =
